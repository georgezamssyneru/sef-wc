...
class BackupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            $getAppAttribute = LogDbBackup::when($sorting, function ($query) use ($sorting) {
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            try {
                ...
                //  CREATE THE CLASS
                LogDbBackup::create( $request->all() );
    ...
    public function update($id, Request $request){
        ...
        try {
            ...
            $getFacility = LogDbBackup::find( $id );
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            LogDbBackup::where('app_version_id', $id)->delete();
