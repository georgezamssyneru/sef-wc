...
class GridAppFormController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $getAppGrid = AppForm::when($sorting, function ($query) use ($sorting) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $getRequest['form_id'] = Str::uuid()->toString();

            //  CREATE THE CLASS
            AppForm::create( $getRequest );
...
//                ->select("CALL generate_grid_attributes(?)",array($request->grid_id));
    ...
    public function update($id, Request $request){
        ...
        try {
            ...
            $getFacility = AppForm::where( 'form_id', $id )->first();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            AppFormAttributes::where('form_id', $id)->delete();

            //  ------------    DELETE THE APP GRID
            $getGrid = AppForm::find($id);
            $getGrid->delete();
