    ...
    const runStore = ( primaryKey ) => {
        ...
        let store = new CustomStore({
            ...
            insert: (values) => {
                ...
                return securedDataManager.createReportingVersion(values).then((data) => {
            ...
            remove: (key) => {
                ...
                return securedDataManager.deleteReporting(key).then((data) => {
            ...
            load(loadOptions) {
                ...
                return securedDataManager.getAppVersion( loadOptions.isLoadingAll
    ...
    const initDataGrid = () =>{
        ...
        return(
            <Grid container spacing={2} sx={{
                ...
                <h3 style={{ textAlign: 'center', width: '100%',  }}>APP VERSION</h3>
