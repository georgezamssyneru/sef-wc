...
import {FormAttributeManager} from "./formManagerAttributes";
...
export function FormManager(props) {
    ...
    const runStoreAppGrid = () => {
        ...
        const storeAppGrid = new CustomStore({
            ...
            insert: (values) => {
                ...
                //  CREATE NEW CLASS ID.
                values['form_id'] = uuidv4();

                //  ----------------    CREATE APP CLASS
                return authDataManager.createAppForm(values).then((data) => {
            ...
            update: (key, values) => {
                ...
                return authDataManager.putGridEditingForm(key, values).then((data) => {
            ...
            remove: (key) => {
                ...
                //  DELETE GRID
                return authDataManager.deleteGridEditingForm(key).then((data) => {
            ...
            load(loadOptions) {
                ...
                return authDataManager.getGridAppForm(loadOptions.isLoadingAll
    ...
    let selectionChanged = (data) => {
        ...
        if(data.selectedRowKeys.length > 0){
            ...
            setSelectedGrid({
                form_id: data.selectedRowKeys[0],
                    ...
                    <Grid container spacing={1}>

                        {
                            ...
                            <Grid sx={{ }} item xl={12} xs={12}
                                ...
                                <h3 style={{ textAlign: 'center' }}>FORMS</h3>
                                ...
                                >
                                    ...
                                    <Column
                                        dataField={'map_service_area_url'}
                                        fixed={true}
                                        caption={'Map Service Area Url'}
                                        width={80}
                                        headerCellRender={renderTitleHeader}
                                        alignment="center"
                                        allowFiltering={false}
