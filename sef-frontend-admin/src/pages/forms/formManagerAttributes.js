 ...
 * @constructor
 */
export function FormAttributeManager(props) {
    ...
    React.useEffect(() => {
        ...
        authDataManager.getGridAttributeFromClassAttribute({ classId : props.formId.class_id }).then((data) => {
    ...
    const runStoreAppGridAttribute = () => {
        ...
        const getOptions = (loadOptions, isExport) => {
            ...
            //  ------- PLACE GRID ID
            params += `formId=${ JSON.stringify( props.formId['form_id'] ) }&`;
        ...
        const storeAppGridAttribute = new CustomStore({
            ...
            insert: (values) => {
                ...
                values['form_id'] = props.formId['form_id'];

                //  ----------------    CREATE APP CLASS
                return authDataManager.createAppFormAttribute(values).then((data) => {
            ...
            update: (key, values) => {
                ...
                return authDataManager.putGridEditingAppFormAttributeClass(key, values).then((data) => {
            ...
            remove: (key) => {
                ...
                //  DELETE GRID
                return authDataManager.deleteGridAppFormAttribute(key).then((data) => {
            ...
            load(loadOptions) {
                ...
                return authDataManager.getGridAppFormAttribute(loadOptions.isLoadingAll
        ...
        <React.Fragment>
            ...
            <Grid container spacing={1}>
                ...
                <Grid sx={{  marginTop: '10px'}} item xl={12} xs={12}
                    ...
                    <h3 style={{ textAlign: 'center' }}>FORM ATTRIBUTES</h3>

                    {
                        ...
                        <Grid sx={{background: '#ECECEC', marginTop: '10px'}} item xl={12} xs={12}
                            ...
                            <DataGrid id="formAttributeClass"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Lookup
                                        dataSource={[
                                            ...
                                            {
                                                value: 'dxFileUploader',
                                                label: 'File uploader'
                                            },
                                            {
                                                value: 'customLocationFinder',
                                ...
                                >
                                    <Lookup
                                        dataSource={[
                                            ...
                                            {
                                                value: 'phoneEditorOptions',
                                                label: 'Phone Editor'
                                            },
                                            {
                                                value: 'editorOptionsAttachment',
                                ...
                                <Column
                                    dataField={'rule_pattern'}
                                    fixed={false}
                                    caption={ 'Rule pattern' }
                                    width={150}
                                    headerCellRender={renderTitleHeader}
                                    alignment="left"
                                    allowFiltering={true}
                                ...
                                <Column
                                    dataField={'rule_message'}
                                    fixed={false}
                                    caption={ 'Rule message' }
                                    width={150}
                                    headerCellRender={renderTitleHeader}
                                    alignment="left"
                                    allowFiltering={true}
