 ...
 * @constructor
 */
export function DashboardTree(props) {
    ...
    const [treeNodeId, setTreeNodeId] = React.useState({
        active: false,
        tree_node_id: null
    });
    ...
    const runStore = ( primaryKey ) => {
        ...
        let store = new CustomStore({
            ...
            update: (key, values) => {
                ...
                return securedDataManager.putAppTreeNode(key,values).then((data) => {
            ...
            insert: (values) => {
                ...
                return securedDataManager.createAppTreeNode(values).then((data) => {
            ...
            remove: (key) => {
                ...
                return securedDataManager.deleteAppTreeNode(key).then((data) => {
            ...
            load(loadOptions) {
                ...
                return securedDataManager.gridAppTreeNode( loadOptions.isLoadingAll
    ...
    const IconClick = (e) => {
        ...
        setTreeNodeId( {
            active: true,
            tree_node_id: e?.row?.data.tree_node_id
        } )
    ...
    const goBack = () =>{
        ...
        setTreeNodeId({ active: false, tree_node_id: null})
    ...
    const initDataGrid = () =>{
        ...
        return(
            <Grid container spacing={2} sx={{
                ...
                <h3 style={{ textAlign: 'center', width: '100%', display: !treeNodeId.active ? 'block' : 'none' }}>Dashboard Groups</h3>
                ...
                >
                    ...
                    <div style={{ maxWidth: '100%', display: !treeNodeId.active ? 'block' : 'none' }}>
                        ...
                        >
                            ...
                            <Column width={100} fixed={true} type="buttons" >
                                ...
                                <Button onClick={IconClick}>
                                    <VisibilityIcon sx={{ cursor:'pointer', marginRight: '20px'}} />
                                </Button>
