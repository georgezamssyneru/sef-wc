...
class MapTest extends DuskTestCase
{
     ...
     * @return void
     */
    public function testMapsAccess()
    {
        $this->browse(function (Browser $browser) {
            ...
            $mapBtnSelector = '#root > div > div > div > div > ul:nth-child(2) > div:nth-child(2) > a:nth-child(1)';
            $browser->waitUntilEnabled($mapBtnSelector, 20)
                    ->click($mapBtnSelector);
            #$browser->pause(10000);
