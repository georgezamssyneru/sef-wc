...
class HipsScenarioSaAllVw extends Model
{

    protected $connection = 'pgsqlMasterData';

    protected $table = 'hips_scenario_sa_all_vw';
    ...
    public function getView(){
        return $this->hasOne('App\Models\MasterData\GridEditing\HipsScenarioSaAll', 'facility_id', 'facility_id');
    }
