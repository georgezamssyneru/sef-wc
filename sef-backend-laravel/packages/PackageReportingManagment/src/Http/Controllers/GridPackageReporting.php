...
class GridPackageReporting extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            $getAppForm = AppReport::when($sorting, function ($query) use ($sorting) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $getRequest['report_id'] = Str::uuid()->toString();

            //  CREATE THE CLASS
            AppReport::create( $getRequest );
...
//                ->select("CALL generate_grid_attributes(?)",array($request->grid_id));
    ...
    public function update($id, Request $request){
        ...
        try {
            ...
            $getFacility = AppReport::where( 'report_id', $id )->first();
